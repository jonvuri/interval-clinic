  ...
  ascending: {
    ...
    Media: [
      {
        ...
        youtubeId: 'M-mAFarwU18',
        youtubeStart: 63,
        youtubeNote: 'Performed by the Film Symphony Orchestra',
      },
      {
    ...
    'Western Classical': [
      ...
      },
      {
        ...
        youtubeId: 'KxnBjAaJWCc',
        youtubeStart: 2,
        youtubeNote: 'Performed by Philippe Jaroussky',
      },
    ],
  },
  descending: {
